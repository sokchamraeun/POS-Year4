    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 text-center max-w-lg w-full mx-4">
        ...
        <div class="bg-gray-50 rounded-xl p-6 text-left space-y-3 mb-6">
            ...
            <div class="flex justify-between text-sm">
                ...
                <span
                    class="inline-block text-xs font-medium px-2.5 py-1 rounded-full bg-green-100 text-green-700">{{ ucfirst($order->status) }}</span>
            </div>
            <div class="flex justify-between text-sm">
                <span class="text-gray-500">Payment</span>
                <span
                    class="inline-block text-xs font-medium px-2.5 py-1 rounded-full bg-green-100 text-green-700">{{ $order->payment_status }}</span>
            </div>
            <div class="flex justify-between text-sm">
