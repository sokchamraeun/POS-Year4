  ...
  return (
    <div className="lg:hidden p-6 grid gap-4">
      {products.map((product) => (
        <div key={product.id} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-lg hover:shadow-slate-200/50 transition-all duration-300">
          ...
          <div className="flex items-center justify-between mt-5 pt-4 border-t border-slate-200">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`inline-flex items-center justify-center w-8 h-8 rounded-lg border transition-all ${product.is_featured ? 'bg-teal-50 border-teal-300 text-teal-500' : 'bg-white border-slate-200 text-slate-300'}`}
              >
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => onEdit(product)} className="px-3 py-1.5 text-xs font-semibold text-teal-600 bg-teal-50 rounded-lg hover:bg-teal-100 transition-all border border-teal-200">Edit</button>
