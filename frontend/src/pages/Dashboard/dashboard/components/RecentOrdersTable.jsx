      ...
      {recentOrders.length > 0 ? (
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="text-left text-gray-500 font-bold uppercase tracking-wider text-xs border-b border-teal-800/20">
            ...
            <tbody>
              {recentOrders.map(o => (
                <tr key={o.id} className="group border-b border-teal-800/10 hover:bg-gradient-to-r hover:from-teal-50/30 hover:to-teal-100/30 transition-colors last:border-0">
                  ...
                  <td className="py-4 pr-4 text-center whitespace-nowrap">
                    <div className="inline-block relative">
                      <select
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-bold border-0 cursor-pointer shadow-sm ring-1 ring-inset ring-teal-700/30 hover:ring-teal-700/50 focus:ring-2 focus:ring-teal-600 transition-all ${paymentColors[o.payment_status ?? 'Unpaid']}`}
                  ...
                  <td className="py-4 pr-4 text-center whitespace-nowrap">
                    <div className="inline-block relative">
                      <select
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-bold border-0 cursor-pointer shadow-sm ring-1 ring-inset ring-teal-700/30 hover:ring-teal-700/50 focus:ring-2 focus:ring-teal-600 transition-all ${statusColors[o.status ?? 'New']}`}
                        style={{ borderRadius: '9999px', WebkitAppearance: 'none', MozAppearance: 'none', appearance: 'none', outline: 'none' }}
                      >
        ...
        <div className="flex flex-col items-center justify-center py-12 px-4 border-2 border-dashed border-teal-800/15 rounded-2xl bg-gradient-to-br from-teal-50/20 to-white">
          <svg className="w-12 h-12 text-teal-600/40 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
          <p className="text-gray-600 font-medium">No orders yet.</p>
          <p className="text-xs text-teal-600/60 mt-1">When customers place orders, they will appear here.</p>
        </div>
      )}
    </div>
  )
