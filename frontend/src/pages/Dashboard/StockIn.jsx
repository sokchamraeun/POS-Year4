        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">Manage purchase orders and stock receiving</p>
            </div>
            <button
              onClick={openAdd}
            ...
            <div className="p-4 border-b border-teal-100 flex items-center gap-3">
              {['', 'Pending', 'Received', 'Cancelled'].map(s => (
                <button key={s}
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-medium transition ${filterStatus === s ? 'bg-teal-900 text-white' : 'bg-teal-50 text-slate-600 hover:bg-teal-100'}`}>
                  {s || 'All'}
                </button>
              ))}
            </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-teal-50">
                    {orders.map(o => (
                      <tr key={o.id} className="hover:bg-teal-50/30 transition">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-teal-100 shrink-0">
            ...
            <div className="overflow-y-auto px-6 py-5 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input value={form.note} onChange={e => setForm(f => ({ ...f, note: e.target.value }))}
                    className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-300" placeholder="Optional note" />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button onClick={addItem} className="text-xs text-teal-900 hover:text-teal-700 font-medium flex items-center gap-1">
                    ...
                    <div key={idx} className="grid grid-cols-12 gap-2 items-center">
                      <div className="col-span-5">
                        <select
                          ...
                          className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-300">
                      ...
                      <div className="col-span-2">
                        <input type="number" min="0" step="0.01"
                          ...
                          className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-300" placeholder="0" />
                      </div>
                      <div className="col-span-2">
                        <input type="number" min="0" step="0.01"
                          value={it.unit_cost}
                          onChange={e => setItemField(idx, 'unit_cost', e.target.value)}
                          className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-300" placeholder="0.00" />
                      </div>
                      <div className="col-span-2">
                        <input readOnly
                          value={it.subtotal !== '' && it.subtotal !== undefined ? Number(it.subtotal).toFixed(2) : ''}
                          placeholder="0.00"
                          className="w-full border border-slate-100 bg-teal-50/30 rounded-lg px-2 py-1.5 text-sm text-slate-600" />
                      </div>
            ...
            <div className="flex gap-3 px-6 py-4 border-t border-teal-100 shrink-0">
      ...
      {detailItem && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      {(detailData.items || []).map(it => (
                        <div key={it.id} className="grid grid-cols-4 text-sm px-1 py-1 rounded hover:bg-teal-50/30">
            ...
            <div className="px-6 py-4 border-t border-teal-100 shrink-0 space-y-2">
