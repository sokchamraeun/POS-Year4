...
export default function Promotions() {
  ...
  const getStatusBadge = (item) => {
    ...
    if (isActive) return { text: 'Active', color: 'teal', bg: 'bg-teal-50', border: 'border-teal-200', textColor: 'text-teal-700' }
    ...
    return { text: 'Inactive', color: 'gray', bg: 'bg-gray-50', border: 'border-gray-200', textColor: 'text-gray-500' }
  }
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <button
              onClick={openCreate}
              className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-600 to-teal-500 text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:from-teal-700 hover:to-teal-600 transition-all duration-200 shadow-lg shadow-teal-200 hover:shadow-xl transform hover:scale-[1.02]"
            >
          ...
          <div className="bg-white rounded-2xl shadow-sm border-2 border-teal-200 overflow-hidden">
            {loading ? (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500 mt-3">Loading promotions...</p>
              </div>
            ) : error ? (
              <div className="p-12 text-center">
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            >
              {/* Modal Header */}
              <div className="bg-gradient-to-r from-teal-600 to-teal-500 px-6 py-4 flex justify-between items-center sticky top-0">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="border-t-2 border-teal-200 pt-4">
                  ...
                  <div className="max-h-48 overflow-y-auto border-2 border-gray-200 rounded-xl p-3 space-y-1 bg-gray-50">
                    {allProducts.map((p) => (
                    ...
                    {form.product_ids.length > 0 && (
                      <div className="text-xs text-teal-600 font-medium mt-2 pt-2 border-t border-gray-200">
                ...
                <div className="flex gap-3 justify-end pt-4 border-t-2 border-teal-200">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2.5 bg-gradient-to-r from-teal-600 to-teal-500 text-white rounded-xl text-sm font-medium hover:from-teal-700 hover:to-teal-600 transition-all shadow-md hover:shadow-lg"
                  >
