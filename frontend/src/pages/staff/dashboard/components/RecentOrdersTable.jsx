  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl shadow-indigo-100/40 p-6 sm:p-8 flex flex-col flex-1 border border-gray-100 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-100/50">
      <div className="flex items-center gap-4 mb-6">
        ...
        {newOrderAlert && (
          <span className="ml-auto animate-pulse px-3 py-1.5 rounded-full text-xs font-black uppercase tracking-wider text-white bg-red-500 shadow-lg shadow-red-500/40">
            New Order!
          </span>
        )}
      </div>
      ...
      {recentOrders.length > 0 ? (
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="text-left text-gray-400 font-bold uppercase tracking-wider text-xs border-b border-gray-100">
            ...
            <tbody>
              {recentOrders.map(o => (
                <tr key={o.id} className="group border-b border-gray-50/80 hover:bg-indigo-50/40 transition-colors last:border-0">
                  ...
                  <td className="py-4 pr-4 text-center whitespace-nowrap">
                    <div className="inline-block relative">
                      <select
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-bold border-0 cursor-pointer shadow-sm ring-1 ring-inset ring-black/5 hover:ring-black/15 focus:ring-2 focus:ring-indigo-500 transition-all ${paymentColors[o.payment_status ?? 'Unpaid']}`}
                  ...
                  <td className="py-4 pr-4 text-center whitespace-nowrap">
                    <div className="inline-block relative">
                      <select
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-bold border-0 cursor-pointer shadow-sm ring-1 ring-inset ring-black/5 hover:ring-black/15 focus:ring-2 focus:ring-indigo-500 transition-all ${statusColors[o.status ?? 'New']}`}
                        style={{ borderRadius: '9999px', WebkitAppearance: 'none', MozAppearance: 'none', appearance: 'none', outline: 'none' }}
                      >
                  ...
                  <td className="py-4 pl-2 text-right whitespace-nowrap">
                    <button 
                      ...
                      className="inline-flex items-center gap-1 text-xs font-bold text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-all opacity-80 group-hover:opacity-100"
                    >
                      View
