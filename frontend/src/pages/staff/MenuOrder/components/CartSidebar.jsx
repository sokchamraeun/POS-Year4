          ...
          <>
            ...
            <div className="border-t border-gray-200 px-4 py-4 shrink-0">
              ...
              <button
                ...
                disabled={placing}
                className="mt-3 w-full bg-green-600 text-white text-sm font-medium py-2.5 rounded-lg hover:bg-green-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {placing && (
