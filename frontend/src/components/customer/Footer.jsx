      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-14 pb-8">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 group mb-5 w-fit">
              ...
              <div className="flex flex-col leading-tight">
                ...
                {settings.tagline && (
                  <span className="text-[10px] text-gray-500 font-medium tracking-[0.2em] uppercase">{settings.tagline}</span>
                )}
              </div>
            </Link>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} {settings.site_name}{settings.tagline ? ` ${settings.tagline}` : ''}. All rights reserved.
          </p>
