    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">isal</span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed">
              Your all-in-one point of sale solution. Streamline your business operations with our modern POS system.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/service" className="hover:text-blue-400 transition-colors">Service</Link>
              </li>
              <li>
                <a href="/#products" className="hover:text-blue-400 transition-colors">Product</a>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} Visal POS. All rights reserved.</p>
